...
assert js2py.eval_jpips('function (r) {return r}')(5) == 5

x, c = js2py.run_file('examples/js2py/esprima.js')
...
#sample_js_code = js2py.get_file_contents('examples/js2py/esprima.js')
